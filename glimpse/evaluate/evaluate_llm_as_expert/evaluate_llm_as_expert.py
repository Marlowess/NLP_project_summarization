...
def parse_args():
    ...
    parser.add_argument("--summaries_by_documents", type=Path, default="")
    args = parser.parse_args()
    return args

def evaluate_summary(documents, generated_summary):
    """
...
def main():
    ...
    for summary_by_docs in summaries_by_documents_df:
        ...
        evaluation = evaluate_summary(documents, generated_summary)
