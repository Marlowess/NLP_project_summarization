...
def parse_args():
    ...
    parser.add_argument("--model_name", type=str, default="LorenzoDeMattei/GePpeTto")
    parser.add_argument("--dataset_path", type=Path, default="data/processed/all_reviews_2025.csv")
